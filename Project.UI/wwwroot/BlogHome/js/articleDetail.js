    ...
    $(function () {
        $(document).on('click', '#btnSave', function (event) {
            ...
            $.post(actionUrl, dataToSend).done(function (data) {
                ...
                const isValid = newFormBody.find('[name="IsValid"]').val() === 'True'; //True'yu string yazdık çünkü _CommentAddPartial'dan alırken string'e çevirmiştik... 
                if (isValid) {
                    const newSingleComment =
                        `<div class="media mb-4">
                            <img class="d-flex mr-3 rounded-circle" src="https://randomuser.me/api/portraits/women/18.jpg" alt="">
                    ...
                    toastr.success(`Sayın ${commentAddAjaxModel.CommentDto.Comment.CreatedByName} yorumunuz başarıyla eklenmiştir. Bir örneği karşınıza gelecek ancak yorumunuz onaylandıktan sonra görünür olacaktır.`);
